                                ...
                                <div class="order_table table-responsive">
                                    <table>
                                        ...
                                        <c:if test="${sessionScope.cart!=null}">
                                            <tfoot>
                                                <tr>
                                                    <th id="total">Tổng giá</th>
                                                    <td headers="total">${sessionScope.total}</td>
                                                </tr>
                                                <tr>
                                                    <th id="shipping">Phí ship</th>
                                                    <td headers="shipping"><strong>30000</strong></td>
                                                </tr>
                                                <tr class="order_total">
                                                    <th id="order_total">Tổng đơn</th>
                                                    <td headers="order_total"><strong>${sessionScope.total + 30000}</strong></td>
                                                </tr>
                                            </tfoot>
                                        </c:if>
                                    </table>
